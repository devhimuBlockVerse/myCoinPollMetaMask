...
//   double _maxECM = 0.0;
//   bool isDisconnecting = false;
//   late WalletViewModel _walletVM;
//
//   @override
//   void initState() {
//     super.initState();
...
//     _walletVM.addListener(_onWalletViewModelChange);
//
//     _fetchWalletAndStageInfo();
//
//   }
//
//
//   void _onWalletViewModelChange() {
//
//     if (_walletVM.isConnected) {
//       _fetchWalletAndStageInfo(); // Fetch prices if connected
//     } else {
//       if (mounted) {
//         setState(() {
//           _ethPrice = 0.0;
...
//   }
//
//   Future<void> _fetchWalletAndStageInfo() async {
//     // await _walletVM.init(context);
//
//     if (_walletVM.isConnected) {
//       try {
//         final stageInfo = await _walletVM.getCurrentStageInfo();
//         final ethPrice = stageInfo['ethPrice'];
//         final usdtPrice = stageInfo['usdtPrice'];
//         final currentECM = stageInfo['ecmSold'];
//         final maxECM = stageInfo['target'];
...
//       } catch (e) {
//         if (mounted) {
//           debugPrint('Error fetching stage info in _fetchWalletAndStageInfo: ${e.toString()}');
//           // Utils.flushBarErrorMessage("Could not get price details. Please connect your wallet or try again.", context); // REMOVED THIS LINE
//           setState(() {
//             _ethPrice = 0.0;
//             _usdtPrice = 0.0;
//             _updatePayableAmount();
...
//           _updatePayableAmount();
//         });
//         // Utils.flushBarErrorMessage("Please connect your wallet to get price details.", context); // REMOVED THIS LINE
//       }
//     }
//   }
//
...
//     _walletVM.removeListener(_onWalletViewModelChange);
//     super.dispose();
//   }
//
//   @override
...
//                            CustomLabeledInputField(
//                             labelText: 'Your Address:',
//                              hintText: walletVM.walletAddress.isNotEmpty && walletVM.isConnected
...
//                                   Utils.flushBarErrorMessage("Please connect your wallet to buy ECM.", context);
//                                   return;
//                                 }
//                                 setState(() {
//                                   isETHActive = true;
