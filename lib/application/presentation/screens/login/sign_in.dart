...
//       if(mounted){
//         setState(() {
//           _hastoken = (prefs.getString('token') ?? '').isNotEmpty;
//         });
//       }
//
//     });
...
//
//
//   String? _chainIdFromSession(ReownAppKitModal modal) {
//     final s = modal.session;
...
//       }
//
//       // Sign new message (safe chainId)
//       final chainId = walletVM.appKitModal!.selectedChain?.chainId
//           ?? _chainIdFromSession(walletVM.appKitModal!);
//
//       if (chainId == null) {
//         ToastMessage.show(
//           message: "Wallet Error",
//           subtitle: "Missing chain ID. Please reconnect your wallet.",
//           type: MessageType.error,
//         );
//         return;
//       }
...
//   }
//
//   Future<void> _onConnectOrGo()async{
//     if(_isNavigating) return;
//     final walletVm = Provider.of<WalletViewModel>(context, listen: false);
//
//     if (!walletVm.isConnected) {
//       await _handleWeb3Login(); // will connect + sign (uses saved signature if present)
//       return;
//     }
//     final prefs = await SharedPreferences.getInstance();
...
//
//
//     // Connected + token present -> navigate
//     if (!mounted) return;
//     Navigator.pushAndRemoveUntil(
//       context,
//       MaterialPageRoute(builder: (_) => const DashboardBottomNavBar()),
