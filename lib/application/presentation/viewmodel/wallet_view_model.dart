...
//
//   bool _hasNavigator(BuildContext context) {
//     final navigator = Navigator.of(context, rootNavigator: true);
//     final hasNavigator = navigator.canPop() || navigator.userGestureInProgress;
//     debugPrint('Context has Navigator: $hasNavigator, canPop: ${navigator.canPop()}');
//     return hasNavigator;
//   }
//
//   @override
...
//   //   try{
//   //     appKitModal = null;
//   //     if (!_hasMaterial(context) || !_hasNavigator(context)) {
//   //       debugPrint('Invalid context for initialization, waiting for valid context');
//   //       throw Exception('Invalid context: Missing MaterialLocalizations or Navigator');
//   //     }
//   //
//   //     appKitModal = ReownAppKitModal(
//   //
...
//   }
//   // Future<void> ensureModalWithValidContext(BuildContext context) async {
//   //   if (appKitModal == null || !_hasMaterial(context) || !_hasNavigator(context)) {
//   //     await init(context);
//   //   }
//   // }
...
//   }
//
//   // Future<void> openWalletModal(BuildContext context) async {
//   //   if (_isLoading || _isReconnecting) return;
//   //
//   //   _walletConnectedManually = true;
//   //   _isLoading = true;
//   //   notifyListeners();
...
//   //     // Check if already connected
//   //     if (_isConnected && appKitModal?.session != null) {
//   //       debugPrint("Already connected, skipping modal open");
//   //       return;
//   //     }
...
//   //         false,
//   //         DateTime.now().difference(start).inMilliseconds,
//   //         extra: {"error": "Connection timeout"},
//   //       );
//   //       return;
//   //     }
//   //
...
// Getters for the new properties
  ...
  Future<void> refreshVesting() async {
    ...
    try {
      ...
      print(
          'refreshVesting: Raw releasedResult = $releasedResult'); // Debug the full result
      // Convert the BigInt to a double and format to 6 decimal places,
      final releasedWei =
          releasedResult.length > 0 ? releasedResult[0] as BigInt : BigInt.zero;
      if (releasedResult.length > 1) {
