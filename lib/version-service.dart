        ...
        return Dialog(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.system_update, color: Color(0XFF1CD691) , size: 64),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color(0XFF1CD691) ,
...
//               mainAxisSize: MainAxisSize.min,
//               children: [
//                 Icon(Icons.system_update, color: Color(0XFF1CD691).withOpacity(0.7), size: 64),
//                 const SizedBox(height: 16),
//                 const Text(
//                   "Update Required 🚀",
//                   style: TextStyle(
...
//                     onPressed: () => _launchUrl(updateUrl),
//                     style: ElevatedButton.styleFrom(
//                       backgroundColor: Color(0XFF1CD691).withOpacity(0.7),
//                       padding: const EdgeInsets.symmetric(vertical: 14),
//                       shape: RoundedRectangleBorder(
//                         borderRadius: BorderRadius.circular(12),
//                       ),
